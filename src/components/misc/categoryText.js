let categoryText =  {
	'combined' : ['Entrepreneurial  Ecosystem Index is the combined index of the the top level indexes, density, diversity & fluidity. It is an indication of the overall level of activity in a metropolitan area\'s entrepreneurial activity.'], 
